...
//
  ...
  #define TFT_MARLINUI_COLOR 0xBFFF
  #define TFT_MARLINBG_COLOR 0x0000
  #define TFT_DISABLED_COLOR 0x0003
  #define TFT_BTCANCEL_COLOR 0xBFFF
  #define TFT_BTARROWS_COLOR 0xBFFF
  #define TFT_BTOKMENU_COLOR 0xBFFF
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      540  // (mm) The length of filament for a complete unload.
